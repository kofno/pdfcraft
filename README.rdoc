...
Pdfcraft initializes an ivar named @pdf the holds the PDF document you are building.

    @pdf.text "This will be rendered in a PDF"

Since Pdfcraft is built on Rails' templating and rendering, this means you that partials, layouts, and helpers are all at yout disposal.
